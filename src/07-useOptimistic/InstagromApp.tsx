...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (formData: FormData) => {
    const newCommentText = formData.get('post-message') as string;
    console.log('Nuevo comentario', newCommentText);

    // Añadir el comentario de forma optimista
